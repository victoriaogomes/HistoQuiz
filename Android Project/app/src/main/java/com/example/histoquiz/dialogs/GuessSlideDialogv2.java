 ...
 */
public class GuessSlideDialogv2 extends AppCompatDialogFragment {

    public TextInputLayout guess;
    public Button goBack, send;
    protected View view;
    protected LayoutInflater inflater;
    protected LocalGameActivity parent;
     ...
     */
    public GuessSlideDialogv2(LocalGameActivity parent){
        this.parent = parent;
    }
    ...
    protected void dealWithButtons(){
        send.setOnClickListener(v -> parent.localOpponent._estado_C(slideChoosed));
