...
/**
 *  Classe utilizada para armazenar as informações necessárias correspondentes a uma solicitação de
 *  amizade
 */
public class FriendRequest {
     ...
     * @param name - nome do amigo associado a essa solicitação de amizade
     * @param UID - identificador único desse amigo associado a essa solicitação de amizade
     */
