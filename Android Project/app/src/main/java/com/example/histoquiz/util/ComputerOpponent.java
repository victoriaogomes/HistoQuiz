...
//        }
        ...
        switch (slideToGuess){
            case "firstSlide":
                if(game_scene.getQuestionRealAnswer(raffledCategory, raffledQuestion, Integer.parseInt(keySet[3].toString())) == answer){
                    game_scene.changePlayerScore(1, 2);
        ...
        switch (game_scene.slideToGuess){
            case "firstSlide":
                if(game_scene.getQuestionRealAnswer(raffledCategory, raffledQuestion, Integer.parseInt(keySet[0].toString())) == myAnswer){
                    game_scene.changePlayerScore(2, 2);
                }
                else{
    ...
    public void _estado_1001(String answer){
        ...
        switch (game_scene.slideToGuess){
            case "firstSlide":
                ...
                _estado_1010(answerValidation, false);
                break;
            case "secondSlide":
    ...
    public void _estado_1010(boolean answerValidation, boolean matchEnded){
        ...
        if(matchEnded){
            (new Handler()).postDelayed(this::_estado_1011, 2000);
        }
        else{
